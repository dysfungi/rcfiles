...
$XONSH_COLOR_STYLE = "dracula"  # https://xon.sh/customization.html#customizing-xonsh-how-do-i
# $XONSH_COLOR_STYLE = "inkpot"  # https://xon.sh/customization.html#customizing-xonsh-how-do-i
# $XONSH_DEBUG = 1
