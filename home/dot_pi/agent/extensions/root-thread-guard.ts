 ...
 * orchestration tools plus read access to plans, global skill roots, and repo
 * task files. There is intentionally no bypass sentinel: disabling this guard means
