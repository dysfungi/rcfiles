/**
 * Vendored from @earendil-works/pi-coding-agent 0.80.6:
 * examples/extensions/questionnaire.ts.
 *
 * Other than this provenance header, intentional deviations are formatting-only
 * to satisfy repository checks.
 */
